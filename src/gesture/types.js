...
/**
 * @typedef {'ROTATE' | 'ZOOM' | 'PAN' | 'IDLE' | 'SELECT' | 'ROTATE_AXIS' | 'ZOOM_FINE' | 'LOCK' | 'SCALE_WORLD' | 'ROLL_CAMERA' | 'MODE_ENTER' | 'PAUSE' | 'HOVER_FOCUS' | 'EXPAND_DETAILS' | 'CLUSTER_EXPAND' | 'CLUSTER_COLLAPSE'} GestureIntent
 */
